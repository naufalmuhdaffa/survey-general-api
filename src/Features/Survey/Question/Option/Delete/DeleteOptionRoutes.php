...
final class DeleteOptionRoutes implements RoutesInterface
{
    public static function dispatch(string $path, string $method, array $segments): bool
    {
        if (
            ...
            $controller = new DeleteOptionController();
            $controller->delete((int) $segments[1], (int) $segments[3], (int) $segments[5]);
            return true;
        }
